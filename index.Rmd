...
Now we want to leverage that work to conduct a COHI assessment at a regional scale in Atlantic Canada. This finer scale should make the COHI more relevant to policy decisions since it corresponds to the managmement regions defined by Fisheries and Oceans Canada. The central challenge is now to identify relevant regional data sources that correspond to the OHI goals. We also need to work with First Nation communities to realign the 'Aboriginal Needs' goal to local priorities.
